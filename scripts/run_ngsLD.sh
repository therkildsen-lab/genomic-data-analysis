...
/workdir/programs/ngsLD/ngsLD --geno $INDIR$INPUT'.glf' --pos $INDIR$SNPLIST --n_ind $NIND --n_sites $NSITES --out $OUTDIR$POP'_ngsLD_output' --probs --log_scale --rnd_sample $PROPSITES --max_kb_dist $MAXDIST --n_threads 8
